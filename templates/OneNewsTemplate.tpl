...
{block 'main'}
   <main class="main">
    ...
    <div class="news-item__picture" style="background-image: url('http://cdn.sportspring.ru/news/1006422/5bbca04427bbe_910x610.jpg');">
    ...
    <div class="news-item__content">
        <div class="news-item__content-wrapper">
            ...
            <div class="news-item__text">
                <p>Начиная с третьей игровой недели, букмекерская контора Maxline предлагает котировки на матчи Первого дивизиона Центр-Запада футзального турнира Премьерлиги.</p><p>Как правило, линия будет появляться в игровой день в районе полудня.</p><p>Играй в Премьерлиге 5х5 - и выигрывай с Maxline!</p>                <div class="clear"></div>
            </div>
                    </div>
